(function() {
    ...
    <div class="swiper-slide">
      <div class="outlet-card bespoke-card" style="cursor: default;">
        <div class="outlet-card-content d-flex flex-column justify-content-between h-100">
          ...
          <div>
            <a href="https://wa.me/971559941020?text=Hi%20GFC%20Direct,%20I%20am%20interested%20in%20a%20mobile%20detailing/upholstery%20service." target="_blank" class="btn btn-red w-100 py-2 text-center d-flex justify-content-center align-items-center gap-2" style="font-size: 11px;">
  ...
  function updateBranchDetails(branch) {
    ...
    if (detailBook) {
      ...
      detailBook.href = `https://wa.me/971559941020?text=${encodeURIComponent(waMessage)}`;
    }
  }
